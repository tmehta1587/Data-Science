...
pairs = [
    ...
    [
        r"what is your name ?",
        ["I am a bot created by Codingal Edu. pvt. Lim. you can call me Jarvus!",]
    ],
    [
        r"how are you ?",
        ["I am doing goodnHow about You ?",]
    ],
    [
        r"sorry (.*)",
    ...
    [
        r"(.*) age?",
        ["I'm a computer program dudenSeriously you are making me this?",]
    ],
    [
        r"What (.*) want ?",
    ...
    [
        r"how is weather in (.*)?",
        ["weather in %1", "Never even heard about %1"]
    ],
    [
        r"i work in (.*)?",
